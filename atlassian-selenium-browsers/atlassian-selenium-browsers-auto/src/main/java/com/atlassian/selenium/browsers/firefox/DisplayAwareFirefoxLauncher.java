...
public class DisplayAwareFirefoxLauncher implements BrowserLauncher
{
    ...
    public DisplayAwareFirefoxLauncher(BrowserConfigurationOptions browserOptions, RemoteControlConfiguration configuration, String sessionId, String browserLaunchLocation) throws InvalidBrowserExecutableException
    {
