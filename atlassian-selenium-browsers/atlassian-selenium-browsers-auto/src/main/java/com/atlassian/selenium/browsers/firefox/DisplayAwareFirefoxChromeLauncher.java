...
public class DisplayAwareFirefoxChromeLauncher extends AbstractBrowserLauncher
{
    ...
    private static Logger LOGGER = Logger.getLogger(DisplayAwareFirefoxChromeLauncher.class);
    ...
    public DisplayAwareFirefoxChromeLauncher(BrowserConfigurationOptions browserOptions, RemoteControlConfiguration configuration, String sessionId, String browserString)  throws InvalidBrowserExecutableException
    {
