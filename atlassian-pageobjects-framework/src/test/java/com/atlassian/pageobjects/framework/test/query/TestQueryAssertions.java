...
import com.atlassian.pageobjects.framework.mock.MockTimedQuery;
import com.atlassian.pageobjects.framework.mock.clock.StrictMockClock;
import com.atlassian.pageobjects.framework.query.ExpirationHandler;
import com.atlassian.pageobjects.framework.query.StaticQuery;
import com.atlassian.pageobjects.framework.query.TimedAssertions;
...
public class TestQueryAssertions
{
    ...
    public void queryEqualsAssertionShouldFailForDifferentQueryResultNow()
    {
        ...
        {
            assertEquals("Query <com.atlassian.pageobjects.framework.query.StaticQuery[interval=100,defaultTimeout=500][value=something]>\n"
    ...
    public void queryEqualsAssertionShouldFailForDifferentQueryResultByDefaultTimeout()
    {
        ...
        {
            assertEquals("Query <com.atlassian.pageobjects.framework.mock.MockTimedQuery[interval=100,defaultTimeout=200]>\n"
    ...
    public void queryEqualsAssertionShouldFailForDifferentQueryResultByCustomTimeout()
    {
        ...
        {
            assertEquals("Query <com.atlassian.pageobjects.framework.mock.MockTimedQuery[interval=100,defaultTimeout=300]>\n"
    ...
    public void isNotNullAssertionShouldFailForNullQueryNow()
    {
        ...
        {
            assertEquals("Query <com.atlassian.pageobjects.framework.mock.MockTimedQuery[interval=100,defaultTimeout=500]>\n"
    ...
    public void isNotNullAssertionShouldFailForNullQueryByDefaultTimeout()
    {
        ...
        {
            assertEquals("Query <com.atlassian.pageobjects.framework.mock.MockTimedQuery[interval=100,defaultTimeout=400]>\n"
    ...
    public void isNotNullAssertionShouldFailForNullQueryByCustomTimeout()
    {
        ...
        {
            assertEquals("Query <com.atlassian.pageobjects.framework.mock.MockTimedQuery[interval=100,"
                    + "defaultTimeout=300]>\n"
