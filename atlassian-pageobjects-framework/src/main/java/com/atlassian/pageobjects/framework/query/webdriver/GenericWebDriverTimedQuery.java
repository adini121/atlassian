...
import com.atlassian.pageobjects.framework.query.AbstractTimedQuery;
...
/**
 * <p>
 * Generic, WebDriver-based implementation of {@link com.atlassian.pageobjects.framework.query.TimedQuery}.
 *
 * <p>
 * It accepts a supplier of the target value and uses it to retrieve current value od the query. The functions are
 * supposed to throw {@link com.atlassian.pageobjects.framework.query.webdriver.GenericWebDriverTimedQuery.InvalidValue}
