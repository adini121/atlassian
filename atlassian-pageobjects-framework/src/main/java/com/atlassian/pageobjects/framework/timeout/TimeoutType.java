 ...
 * {@link com.atlassian.pageobjects.framework.query.TimedQuery#by(long)}
 * and {@link com.atlassian.pageobjects.framework.query.TimedQuery#by(long, java.util.concurrent.TimeUnit)}).
 *
 */
public enum TimeoutType
{
    /**
     * Default timeout value. Meant to be used in case there is no explicit timeout provided for a component requiring
     * it.
     *
     */
    DEFAULT,
     ...
     *
     * @see com.atlassian.pageobjects.framework.query.TimedQuery
     * @see com.atlassian.pageobjects.framework.query.PollingQuery
     */
    EVALUATION_INTERVAL,
    ...
    */
    ...
    /**
     * Load time of an UI-heavy component (e.g. drop-down, picker etc.)
     *
     */
    COMPONENT_LOAD,
