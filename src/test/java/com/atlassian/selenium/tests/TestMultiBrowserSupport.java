...
public class TestMultiBrowserSupport extends SeleniumMultiTest
{
    ...
    public List<SeleniumConfiguration> getSeleniumConfigurations()
    {
        ...
        configs.add(new ParameterizedSeleniumConfiguration("localhost", 4444,"*firefox", "http://www.google.com/"));
        configs.add(new ParameterizedSeleniumConfiguration("localhost", 4444, "*safari", "http://www.google.com/"));
        return configs;
    }
