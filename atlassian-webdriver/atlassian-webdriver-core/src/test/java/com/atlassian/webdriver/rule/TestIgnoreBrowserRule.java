...
public class TestIgnoreBrowserRule
{
    ...
    public void shouldSkipForAnnotatedTestMethodWithMultipleValues()
    {
        final IgnoreBrowserRule rule = new IgnoreBrowserRule(Browser.CHROME);
        final SafeStatementInvoker invoker = new SafeStatementInvoker(rule.apply(statement,
                Descriptions.forTest(MockClassWithRequireMethods.class, "methodAnnotatedWithRequireBrowserMultipleValues")));
        invoker.invokeSafely();
        assertFailedAssumption(invoker);
    }
    ...
    {
        @Test
        @RequireBrowser(value = Browser.HTMLUNIT)
        public void methodAnnotatedWithRequireBrowserHtmlUnit() {}

        @Test
        @RequireBrowser(value = { Browser.HTMLUNIT, Browser.ANDROID, Browser.FIREFOX })
        public void methodAnnotatedWithRequireBrowserMultipleValues() {}

        @Test
        @RequireBrowser(value = Browser.ALL)
        public void methodAnnotatedWithRequireAll() {}
    }

    @RequireBrowser(value = {Browser.HTMLUNIT, Browser.FIREFOX})
